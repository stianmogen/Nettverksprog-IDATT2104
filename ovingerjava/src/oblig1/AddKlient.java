...
class AddKlient {
    public static void main(String[] args) throws IOException {
        ...
        while (!regnestykke.equals("nei")) {  //så lenge vi ikke skal slutte
            String svar = leseren.readLine(); //får svaret på regnestykket
            ...
            skriveren.println(regnestykke); //sender regnestykket for utregninger
        }
